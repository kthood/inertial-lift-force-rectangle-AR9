function [forcex,forcey]=getLiftForceO4_AR9(x,y,rsph,U,rho,L)
%% INPUT:
...
if x<-4.5*L || x>4.5*L || y<-L/2 || y>L/2
    error(['location outside channel: pick ',num2str(-9*L/2),' < x < ',num2str(9*L/2),' and ',...
        num2str(-L/2),' < y < ',num2str(L/2)])
...
% otherwise proceed
    ...
    load HoLeal_channel_aspectratio9_Re1_mesh8_04-05-2016.mat
